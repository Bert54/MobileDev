...
public class EditorCharacterTarget extends EditorButton {
    ...
    public EditorCharacterTarget(World world) {
        super();
    ...
    public void draw(SpriteBatch sb) {
        sb.draw(TextureFactory.getInstance().getTargetBeige(), positionX, positionY, this.size, this.size);
    }
}
