...
public class EditorBlocSquare extends EditorButton {
    ...
    public EditorBlocSquare(World world) {
        super();
    ...
    public void draw(SpriteBatch sb) {
        sb.draw(TextureFactory.getInstance().getBlock(), positionX, positionY, this.size, this.size);
    }
