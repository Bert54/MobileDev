...
public class EditorRewrite extends EditorButton {
    ...
    public EditorRewrite(World world) {
        super();
    ...
    public void draw(SpriteBatch sb) {
        sb.draw(TextureFactory.getInstance().getRewrite(), positionX, positionY, this.size, this.size);
    }
}
