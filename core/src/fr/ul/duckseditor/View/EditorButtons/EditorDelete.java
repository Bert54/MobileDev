...
public class EditorDelete extends EditorButton {

    protected float size = Math.max(CAMERAWIDTH/40f, CAMERAHEIGHT/40f) * 3;

    protected static float positionX = CAMERAWIDTH/9.5f;
    protected static float positionY = CAMERAHEIGHT/6f;

    public EditorDelete(World world) {
        super();
    ...
    public void draw(SpriteBatch sb) {
        sb.draw(TextureFactory.getInstance().getTrash(), positionX, positionY, this.size, this.size);
    }
