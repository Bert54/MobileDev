...
public class Square extends Block {
    ...
    public Square(World world) {
        ...
        this.height = Math.max(UMWIDTH,UMHEIGHT);
    ...
    public void draw(SpriteBatch sb) {
        sb.draw(TextureFactory.getInstance().getBlock(), this.body.getPosition().x, this.body.getPosition().y,0, 0, this.width, this.height, 1, 1, this.body.getAngle() * MathUtils.radiansToDegrees, 0, 0, 70, 70, false, false);
